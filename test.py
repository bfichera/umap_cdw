...
for window_length in window_lengths:
    ...
    logger.info(f'Single window length finished after {time.time() - iteration_start_time} seconds.')

logger.info(f'Entire script finished after {time.time() - start_time} seconds.')
